...
// fetches from the backend. on error, it returns an instance of timeseries_storage.TimeseriesStorageError
...
var samplerMap map[timeseries_storage.SampleMethod]sampler = map[timeseries_storage.SampleMethod]sampler{
